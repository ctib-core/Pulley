...
contract TradingPoolFuzzTest is Test {
    ...
    function testFuzz_DepositAsset(uint256 amount) public {
        ...
        // Check invariants
        assertEq(tradingPool.getTotalPoolValue(), initialPoolValue + amount, "Pool value should increase by deposit amount");
        assertEq(tradingPool.getAssetBalance(address(mockUSDC)), initialAssetBalance + amount, "Asset balance should increase");
    ...
    function testFuzz_RecordTradingProfit(uint256 depositAmount, uint256 profitAmount) public {
        ...
        assertEq(tradingPool.getPendingProfitDistribution(), initialPendingDistribution + profitAmount, "Pending distribution should increase");
    }
